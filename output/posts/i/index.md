---
title: "Enrôlement avec Windows Autopilot"
date: 2023-03-24
categories: 
  - "inscription-windows"
  - "windows"
coverImage: "titre-windowsautopilot.png"
---
...
![](images/provisioning1.png)

![](images/provisioning2.png)

![](images/provisioning3.png)
...
![](images/autopilot-scenario-a.png)
...
![](images/autopilot-scenario-b.png)
...
![](images/autopilot-scenario-c.png)
...
![](images/autopilot-scenario-d.png)
...
![](images/autopilot-scenario-e.png)
...
[![](images/lien-autopilot.png)](https://tuneincloud.fr/2023/03/20/inscription-windows/)

**Lien vers Article "Inscription Windows "**

![](images/lien-autopil-cloud.png)

Lien vers Article **"Windows Autopilot : Créer un profil d'enrôlement jonction Azure AD (Full Cloud)"** - _en cours de rédaction_

![](images/lien-autopil-hybrid.png)

**Lien vers Article "Windows Autopilot : Créer un profil d'enrôlement jonction Hybride Azure AD"** - _en cours de rédaction_

![](images/lien-selfdeploy.png)

Lien vers Article **"Windows Autopilot : Créer un profil d'auto-déploiement (Kiosque)"** - _en cours de rédaction_

![](images/lien-existingdevice.png)

**Lien vers Article "Windows Autopilot : Créer un profil d'enrôlement pour périphériques existants"** - _en cours de rédaction_

![](images/lien-esp.png)

Lien vers Article **"Page d'Etat de l'inscription (ESP)"** - _en cours de rédaction_
