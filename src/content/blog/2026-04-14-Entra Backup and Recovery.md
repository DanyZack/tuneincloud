...
Jusqu'ici, récupérer un objet Entra supprimé par erreur — un groupe, un compte de service, une Conditional Access policy mal configurée — imposait soit de fouiller la corbeille (30 jours, mais limitée en types d'objets), soit de s'appuyer sur un outil tiers comme **EntraExporter**, **AzureAD Backup**, ou une solution CIEM.
