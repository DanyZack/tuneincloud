...
description: "Comprendre les moyens de faire de l'enrôlement automatique avec les périphériques iOS et iPadOS sur Microsoft Intune"
pubDate: 2023-03-16
category: "guides"
subcategory: "intune"
...
Disposer d'un accès administrateur au portail Microsoft Intune et d'un compte Apple (professionnel ou personnel) pour accéder au portail Apple Push Certificates.
...
### 5. Télécharger le fichier CSR

**Télécharger le fichier CSR** généré par Intune. Ce fichier sera utilisé pour demander le certificat Push MDM auprès d'Apple.

---

### 6. Créer le certificat sur le portail Apple

Se connecter au portail **[Apple Push Certificates](http://go.microsoft.com/fwlink/?LinkId=261984)** avec un compte Apple (professionnel ou personnel), puis cliquer sur le bouton **"Create a Certificate"**. Accepter les conditions d'utilisation en cliquant sur **"Accept"**.

---

### 7. Importer le CSR et télécharger le certificat

Dans la page de création du certificat, cliquer sur **"Choisir un fichier"** et importer le fichier CSR Intune précédemment téléchargé. Valider en cliquant sur **"Upload"**.

![Import du fichier CSR dans le portail Apple Push Certificates](/images/old/pushmdmapplescreen.png)

Une fois le certificat généré, le récupérer en cliquant sur le bouton **"Download"**. Le certificat est au format PEM.

![Téléchargement du certificat Push MDM Apple](/images/old/pushmdmapplescreen2.png)

> Pour tout renouvellement futur du certificat, utiliser le bouton **"Manage Certificates"** sur le même portail Apple, avec le même compte Apple ayant servi à la création initiale.

---

### 8. Renseigner l'identifiant Apple dans Intune

Revenir sur le portail Intune et renseigner l'**identifiant Apple** utilisé pour créer le certificat Push MDM. Cet identifiant est conservé à titre indicatif pour retrouver le bon compte Apple lors du renouvellement annuel du certificat.

---

### 9. Charger le certificat et finaliser

Charger le certificat Push MDM Apple au format PEM, puis valider en cliquant sur le bouton **"Charger"**.

Une fois l'ensemble de ces actions effectuées, la liaison entre Intune et Apple est activée, ce qui ouvre l'accès aux différents profils d'enrôlement Apple (iOS et iPadOS).
